...
import { FaHeadphones, FaTv, FaWatchmanMonitoring } from "react-icons/fa"
import { MdMonitor, MdCable, MdDiscount, MdNewspaper, 
  // MdPackage
 } from "react-icons/md"
...
const categories = [
  { name: "Điện thoại, Tablet", icon: <AiOutlineMobile className="h-4 w-4" /> },
  { name: "Laptop", icon: <AiOutlineLaptop className="h-4 w-4" /> },
  { name: "Âm thanh, Míc thu âm", icon: <FaHeadphones className="h-4 w-4" /> },
  { name: "Đồng hồ, Camera", icon: <FaWatchmanMonitoring className="h-4 w-4" /> },
  { name: "Đồ gia dụng", icon: <AiOutlineHome className="h-4 w-4" /> },
  { name: "Phụ kiện", icon: <MdCable className="h-4 w-4" /> },
  { name: "PC, Màn hình, Máy in", icon: <MdMonitor className="h-4 w-4" /> },
  { name: "Tivi", icon: <FaTv className="h-4 w-4" /> },
  { name: "Thu cũ đổi mới", icon: <AiOutlineSync className="h-4 w-4" /> },
 
  { name: "Khuyến mãi", icon: <MdDiscount className="h-4 w-4" /> },
  { name: "Tin công nghệ", icon: <MdNewspaper className="h-4 w-4" /> },
]
  ...
  return (
    <main className="max-w-7xl mx-auto px-4 py-4">
      <div className="flex flex-col md:flex-row gap-4">
        ...
        <div className="w-full md:w-1/5 border rounded-md shadow-sm overflow-hidden">
          <div className="bg-gray-50 p-3 font-medium text-gray-700 border-b">Danh mục sản phẩm</div>
        ...
        <div className="w-full md:w-4/5">
          ...
          <div className="grid grid-cols-2 md:grid-cols-6 gap-2">
            {products&& products?.length >0 && products?.map((product, index) => (
              ...
              >
                <div className="text-sm font-medium mb-1">{product.productname}</div>
                <div className="text-xs text-gray-500 mb-2">{product.producttype}</div>
...

          {
            ...
            <div className="bg-green-100 rounded-md p-4 flex flex-col items-center">
              <div className="text-xl font-medium mb-2">{product[8].productname}</div>
